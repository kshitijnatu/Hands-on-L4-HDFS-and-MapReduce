...
## Actual Output for this Hands On Activity

This output was generated by running the job on the hands‑on input in `shared-folder/input/data/input.txt` and copying `/output3/part-r-00000` from HDFS.
